...
# Django va aller chercher la vue (view)
...
urlpatterns = [
    ...
    path(
        ...
        views.create_review_response_view,
    ...
    path(
        "ticket/<int:ticket_id>/delete/", views.delete_ticket_view, name="ticket_delete"
    ),
    ...
    path(
        "review/<int:review_id>/delete/", views.delete_review_view, name="review_delete"
    ),
...
# Désormais, les images stockées dans le répertoire MEDIA_ROOT
